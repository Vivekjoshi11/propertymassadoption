...
// import fs from 'fs';
// import csvParser from 'csv-parser'; // CSV parsing library
...
// router.post('/upload-csv', upload.single('file'), async (req: CustomRequest, res: Response): Promise<void> => {
//   if (!req.file) {
...
//     const destinationDirectory = path.join(__dirname, '../../build/src/inputFiles');
...
//     await runScript('./build/src/scripts/1-getCoOrdinates.js');
//     console.log('Step 1 completed successfully.');

//     console.log('Step 2: Running 2-addPropertiesToDb.js...');
//     await runScript('./build/src/scripts/2-addPropertiesToDb.js');
//     console.log('Step 2 completed successfully.');

//     console.log('Step 3: Running 3-mintTx.js...');
//     await runScript('./build/src/scripts/3-mintTx.js');
...
// const apiRoute = nextConnect<CustomRequest, NextApiResponse>();

// apiRoute.use(upload.single('file'));

// apiRoute.post(async (req: CustomRequest, res: NextApiResponse) => {
//   if (!req.file) {
//     res.status(400).json({ message: 'File not provided!' });
//     return;
//   }
...
//     const destinationDirectory = path.join(process.cwd(), 'build/src/inputFiles');
//     const destinationFilePath = path.join(destinationDirectory, 'allAddress.json');
